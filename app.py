...
# ------------------------------
# The custom HTML now uses Clerk integration and Tailwind for the nav bar while preserving the details panel.
custom_html = """
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Insn – Interactive Data Map</title>
    <!-- Tailwind via CDN -->
    <script src="https://cdn.tailwindcss.com"></script>
    <!-- Import Raleway for navigation and headings -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Raleway:wght@400;700&display=swap" />
    <!-- Import Roboto for content in details and chat -->
    ...
    <style>
      ...
      .gradient-border {
        ...
        border-image-source: linear-gradient(45deg, #f79533, #f37055, #ef4e7b, #a166ab, #5073b8, #1098ad, #07b39b, #6fba82);
        animation: gradientAnimation 5s ease infinite;
      }
      /* Additional styling for details panel and notifications */
      #topNotification {
        position: fixed;
        top: 8px;
        left: 50%;
      ...
      /* Override font for paper details and chat so they use Roboto */
      #node-details-section, #chat-section, #chat-container, #chat-conversation, #chat-controls, #chat-input, #chat-controls button {
    ...
    <!-- Load Clerk's JavaScript SDK from CDN -->
    <script async crossorigin="anonymous" data-clerk-publishable-key="pk_test_ZmluZS1yYXktMzEuY2xlcmsuYWNjb3VudHMuZGV2JA" src="https://cdn.jsdelivr.net/npm/@clerk/clerk-js@latest/dist/clerk.browser.js" type="text/javascript"></script>
    <script type="module">
      // Clerk integration for mounting the UserButton.
  ...
  <body class="bg-gray-50">
    <!-- Navigation Bar -->
    <nav class="w-full py-6 px-4 md:px-12 flex items-center justify-between">
      <div class="text-2xl font-bold gradient-text">Insn</div>
      <div class="flex items-center space-x-6">
        <a href="#features" class="hover:underline">Features</a>
        <a href="#about" class="hover:underline">About</a>
        <a href="#contact" class="hover:underline">Contact</a>
        <!-- This div will show the Clerk user button when signed in -->
      ...
      <div id="chat-section">
        ...
        <div id="chat-container">
          ...
          <div id="chat-controls">
            <textarea id="chat-input" placeholder="Describe the findings of this research..."></textarea>
    ...
    <script>
      ...
      document.getElementById("chat-submit").addEventListener("click", function() {
        ...
        if (!query && context) {
          query = "Describe the findings of this research: " + currentPaper.title + ". Please cite all your resources.";
        }
        if (!query) return;
